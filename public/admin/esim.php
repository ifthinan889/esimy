...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/esim-style.css?v=<?= file_exists(__DIR__ . '/../assets/css/esim-style.css') ? filemtime(__DIR__ . '/../assets/css/esim-style.css') : time() ?>">
...
<script src="../assets/js/esim.js?v=<?= file_exists(__DIR__ . '/../assets/js/esim.js') ? filemtime(__DIR__ . '/../assets/js/esim.js') : time() ?>"></script>
</body>
</html>