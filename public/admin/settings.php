...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/settings.css?v=<?= file_exists(__DIR__ . '/../assets/css/settings.css') ? filemtime(__DIR__ . '/../assets/css/settings.css') : time() ?>">
...
<script src="../assets/js/settings.js?v=<?= file_exists(__DIR__ . '/../assets/js/settings.js') ? filemtime(__DIR__ . '/../assets/js/settings.js') : time() ?>"></script>
</body>
</html>