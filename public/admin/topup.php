...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/topup.css?v=<?= file_exists(__DIR__ . '/../assets/css/topup.css') ? filemtime(__DIR__ . '/../assets/css/topup.css') : time() ?>">
...
<script src="../assets/js/topup.js?v=<?= file_exists(__DIR__ . '/../assets/js/topup.js') ? filemtime(__DIR__ . '/../assets/js/topup.js') : time() ?>"></script>
</body>
</html>